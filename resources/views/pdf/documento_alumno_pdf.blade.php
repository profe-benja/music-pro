...
<div class=WordSection1>
  ...
  <img src="https://upload.wikimedia.org/wikipedia/commons/a/aa/Logo_DuocUC.svg" width="160" alt="">
  <div align="center">
  ...
  <table style="border-collapse: collapse; width: 100%; border: none; border-collapse: none;">
    <tbody>
      ...
      <tr class="">
        ...
        <td style="width: 50%" style="border: none; border-collapse: none; font-size:10pt;">RECEPTOR DUOC UC: {{ current_user()->nombre_completo() ?? '' }}</td>
      </tr>
      <tr class="">
      ...
      <tr class="">
        <td style="width: 50%" colspan="2" style="border: none; border-collapse: none; font-size:10pt;">TELÉFONO CELULAR: {{ $a->celular }}</td>
      </tr>
      <tr class="">
        <td style="width: 50%" colspan="2" style="border: none; border-collapse: none; font-size:10pt;">CORREO ELECTRÓNICO: {{ $a->correo ?? '' }}</td>
      </tr>
    </tbody>
  </table>
