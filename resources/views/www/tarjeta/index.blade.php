...
<main class="flex-shrink-0">
  ...
  <header data-bs-theme="dark">
    <div class="navbar navbar-dark btn-bd-woow shadow-sm fixed-top">
        <div class="container">
  ...
  <!-- Header-->
  <header class="btn-bd-woow py-2 content">
              ...
              <div class="col-lg-8 col-xl-7 col-xxl-6">
                  <div class="my-5 text-center">
                      ...
                      <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-center">
                        <a class="btn btn-bd-primary btn-lg px-4 me-sm-3" href="#features">BEATPAY FREE</a>
        ...
        <div class="row gx-5 align-items-center justify-content-center">
            <div class="col-lg-8 col-xl-7 col-xxl-6">
                <div class="my-5 text-center">
                    ...
                    <p class="lead fw-normal text-white mb-4 text-center">
                      Creemos en hacer que la experiencia de compra y pago en eventos musicales y conciertos sea accesible para todos. Es por eso que ofrecemos nuestra tarjeta virtual Visa - Cuenta Digital Virtual de forma completamente gratuita, sin costos ni comisiones ocultas.
