...
class UsuarioController extends Controller
{
  public function index() {
    ...
    return view('bodega.usuario.index', compact('usuarios'));
  }
  ...
  public function create() {
    return view('bodega.usuario.create');
  }
  ...
  public function store(StoreUsuarioRequest $request) {
    ...
    return redirect()->route('bodega.usuario.index')->with('success','Se ha creado correctamente');
  }

  public function show($id) {
    $u = Usuario::findOrFail($id);

    return view('bodega.usuario.show', compact('u'));
  }

  public function edit($id) {
    $u = Usuario::findOrFail($id);
    return view('bodega.usuario.edit', compact('u'));
  }
